...
class BrowserWindow(QMainWindow):
    def __init__(self):
        ...
        # Disable session saving, cookies, and identifiers
        QSettings().clear()
        default_profile = QWebEngineProfile.defaultProfile()
        default_profile.setPersistentCookiesPolicy(QWebEngineProfile.NoPersistentCookies)
        default_profile.setHttpCacheType(QWebEngineProfile.NoCache)
